            ...
            <div>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="btn-group btn-group-vertical" data-toggle="buttons">
                            <label class="btn active">
                                <input type="radio" name='comment1' v-model = "form.comment" value="completed activity" ><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i> <span>  Completed Activity</span>
                            </label>
                            <label class="btn active">
                                <input type="radio" name='comment2' v-model = "form.comment" value="good turn"><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i><span> Good turn daily</span>
                            </label>
                ...
                <div class="col">
                    <div class="col-xs-12">
                        ...
                        <div class="btn-group btn-group-vertical" data-toggle="buttons">
                            <label class="btn active">
                                <input type="radio" name='score1' v-model = "form.score" value="1" checked><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i> <span>  1</span>
                            </label>
                            <label class="btn active">
                                <input type="radio" name='score2' v-model = "form.score" value="2" ><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i><span> 2</span>
                            </label>
                            <label class="btn active">
                                <input type="radio" name='score3' v-model = "form.score" value="3" ><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i><span> 3</span>
                            </label>
                        </div>
